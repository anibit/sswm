...
def html_footer():
    return '''
        <br><br>
        <span>Metrics generated by: <br> <strong>Stupid Simple Website Metrics (C)2014-2015 by <a href="http://www.bytecruft.com">Jon Wolfe</a>/
        <a href="https://anibit.com">Anibit Technology LLC</a></strong>
        <br><br>
        See the <a href="http://github.com/anibit">Project Page on GitHub</a> for more information.
        </span>
        </body>
    </html>
    '''
